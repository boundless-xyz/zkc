 ...
 *   1. ZKC.upgradeToAndCall(ZKCRecovery, recoverSelfTransfer(RECIPIENT, AMOUNT))
...
contract RecoverZKC is Script {
    ...
    function run() public {
        ...
        bytes memory call1 = abi.encodeWithSignature(
            ...
            recoveryImpl,
            abi.encodeCall(ZKCRecovery.recoverSelfTransfer, (RECIPIENT, AMOUNT))
        );
        ...
        console2.log("Call 1: upgradeToAndCall(ZKCRecovery, recoverSelfTransfer(recipient, amount))");
