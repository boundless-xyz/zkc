...
contract ZKCInitializersTest is Test {
    ...
    function setUp() public {
        ...
        zkc.upgradeToAndCall(
            ...
            abi.encodeWithSelector(ZKC.initializeV2.selector)
        );
    }
    ...
    function test_totalSupply_ReturnsInitialSupplyBeforeInitializeV3() public {
        // totalSupply should return INITIAL_SUPPLY before epochs start
        assertEq(zkc.totalSupply(), zkc.INITIAL_SUPPLY(), "totalSupply should return INITIAL_SUPPLY before epochs start");
    }
    ...
    function test_emissionFunctionsWorkAfterInitializeV3() public {
        ...
        assertEq(povwEmissions, (emissions * zkc.POVW_ALLOCATION_BPS()) / zkc.BASIS_POINTS(), "PoVW emissions should be 75% of total");
        ...
        assertEq(stakingEmissions, (emissions * zkc.STAKING_ALLOCATION_BPS()) / zkc.BASIS_POINTS(), "Staking emissions should be 25% of total");
