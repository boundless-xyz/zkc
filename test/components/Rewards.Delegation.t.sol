...
contract RewardsDelegationTest is veZKCTest {
    ...
    function testSelfRewardDelegationByDefault() public {
        ...
        assertEq(veToken.getStakingRewards(alice), AMOUNT / Constants.REWARD_POWER_SCALAR, "Should have reward power equal to stake/scalar");
    }
    ...
    function testSimpleRewardDelegation() public {
        ...
        assertEq(veToken.getStakingRewards(bob), AMOUNT / Constants.REWARD_POWER_SCALAR, "Bob should have Alice's reward power");
    }
    ...
    function testRewardDelegationChangeUpdatesRewards() public {
        ...
        assertEq(veToken.getStakingRewards(CHARLIE), AMOUNT / Constants.REWARD_POWER_SCALAR, "Charlie should have Alice's reward power");
    }
    ...
    function testDelegateRewardsBackToSelf() public {
        ...
        assertEq(veToken.getStakingRewards(alice), AMOUNT / Constants.REWARD_POWER_SCALAR, "Alice should have her reward power back");
        assertEq(veToken.getStakingRewards(bob), 0, "Bob should have no reward power");
    }
    ...
    function testAddToStakeWithRewardDelegation() public {
        ...
        assertEq(veToken.getStakingRewards(bob), AMOUNT / Constants.REWARD_POWER_SCALAR, "Bob should have initial reward power");
        ...
        assertEq(veToken.getStakingRewards(bob), (AMOUNT * 2) / Constants.REWARD_POWER_SCALAR, "Bob should have increased reward power");
    ...
    function testIndependentRewardAndVoteDelegation() public {
        ...
        assertEq(veToken.getStakingRewards(bob), 0, "Bob should have no reward power");
        assertEq(veToken.getStakingRewards(CHARLIE), AMOUNT / Constants.REWARD_POWER_SCALAR, "Charlie should have reward power");
    }
    ...
    function testSwitchRewardDelegationIndependently() public {
        ...
        assertEq(veToken.getStakingRewards(CHARLIE), AMOUNT / Constants.REWARD_POWER_SCALAR, "Charlie should gain reward power");
    }
    ...
    function testHistoricalRewardPowerAfterDelegation() public {
        ...
        assertEq(veToken.getPastStakingRewards(alice, checkpoint1), AMOUNT / Constants.REWARD_POWER_SCALAR, "Alice should have had reward power at checkpoint1");
        assertEq(veToken.getPastStakingRewards(bob, checkpoint1), 0, "Bob should have had no reward power at checkpoint1");
        
        assertEq(veToken.getPastStakingRewards(alice, checkpoint2), 0, "Alice should have had no reward power at checkpoint2");
        assertEq(veToken.getPastStakingRewards(bob, checkpoint2), AMOUNT / Constants.REWARD_POWER_SCALAR, "Bob should have had reward power at checkpoint2");
        assertEq(veToken.getPastStakingRewards(CHARLIE, checkpoint2), 0, "Charlie should have had no reward power at checkpoint2");
    }
    ...
    function testHistoricalPoVWCapAfterDelegation() public {
        ...
        assertEq(veToken.getPastPoVWRewardCap(alice, checkpoint1), expectedCap, "Alice should have had PoVW cap at checkpoint1");
