...
contract SupplyTest is Test {
    ...
    function testConsistencyAcrossYearBoundaries() public {
        // Verify supply calculation is continuous across year boundaries
        ...
        // expectedSupply182 = PRBMath calculation from supply181 (calculated using PRBMath in library)
        // The tiny difference comes from accumulated rounding in intermediate PRBMath calculations
    ...
    function testManualGrowthFactorApplication() public {
        ...
        console.log("Testing PRBMath application of growth factors:");
        console.log("");
        
        uint256 supply = INITIAL_SUPPLY;
        
        // Test Year 0 -> Year 1
        console.log("Year 0 supply: %s", supply);
        ...
        console.log("Year 1 supply (PRBMath): %s", supply);
        console.log("Year 1 supply (hardcoded): %s", Supply.SUPPLY_YEAR_1);
        ...
        console.log("Year 2 supply (PRBMath): %s", supply);
        console.log("Year 2 supply (hardcoded): %s", Supply.SUPPLY_YEAR_2);
        ...
        console.log("Year 3 supply (PRBMath): %s", supply);
        console.log("Year 3 supply (hardcoded): %s", Supply.SUPPLY_YEAR_3);
        ...
        for (uint256 i = 0; i < factors.length; i++) {
            ...
            assertEq(supply, hardcodedSupplies[i], string(abi.encodePacked("PRBMath Year ", year, " calculation should match hardcoded value")));
        }
        
        console.log("");
        console.log("All PRBMath calculations match hardcoded values!");
    }
    
    function testManualLoopsVsLibrary() public {
        // Compare manual loop calculations with library function to ensure consistency
        console.log("Testing Manual Loops vs Library calculations:");
        console.log("");
        ...
        for (uint256 i = 0; i < testEpochs.length; i++) {
            ...
            console.log("  Manual loops: %s", manualSupply);
            console.log("  Library func: %s", librarySupply);
